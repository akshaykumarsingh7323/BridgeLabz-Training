...
public class NoteServiceImpl implements NoteService {
	...
	public NoteResponse createNote(String email, NoteRequest request) {
		...
		notificationProducer.sendNotification("New note created: " + savedNote.getTitle());
	...
	private NoteResponse convertToResponse(Note note) {
		...
		return new NoteResponse(note.getId(), note.getTitle(), note.getContent(), note.getCreatedAt(),
				note.getUpdatedAt(), note.getReminderTime(), note.isPinned(), note.isArchived(), note.isTrashed());
	}
